...
The active implementation uses hooks plus transcript parsing instead of asking Claude to log its own replies.

- Hook config is installed through `~/.claude/settings.json`
